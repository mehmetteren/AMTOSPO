...
tk.Label(frame_rightUp, bg='light grey', text='Welcome to amtospo!', font="Verdana 25 bold").pack(anchor='s', padx=25,
                                                                                                  pady=25)
...
tk.Label(frame_rightDown, bg='light grey', text='File name or Url: ', font="Verdana 17 bold").pack(anchor='nw', padx=10,
                                                                                                   pady=10)
...
def send():
    if transType_default and text != 'Buraya giriniz...':
